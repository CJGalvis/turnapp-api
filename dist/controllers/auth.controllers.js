...
exports.signIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const data = yield TenantModel_1.default.findOne({ email });
        if (!data)
        ...
        yield TenantModel_1.default.findOneAndUpdate({ email }, { $set: { lastSign: new Date() } });
...
exports.signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { body } = req;
        let data = yield TenantModel_1.default.findOne({ email: body.email });
        if (data)
            return res.status(400).send({
                message: 'El email ya está en uso'
            });
        data = yield TenantModel_1.default.findOne({ identification: body.identification });
        if (data)
            return res.status(400).send({
        ...
        const newtenant = new TenantModel_1.default({
            name: body.name,
            created: new Date(),
...
exports.currentUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = yield TenantModel_1.default.findById(req.tenant);
        res.status(200).send({
            message: 'OK',
            data
        });
